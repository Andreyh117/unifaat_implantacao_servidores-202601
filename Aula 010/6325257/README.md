...
**R: O usuário é a identidade individual, enquanto o grupo são equipes de usuários com permissões compartilhadas.**
...
**R: O crachá de visitante dá permissões temporárias sem expor credenciais fixas.**
...
**R: Subnet Pública: Acesso direto à internet. Ideal para web. Subnet Privada: Sem rota de entrada. Apenas recursos restritos.**
...
![alt text](<aws configure list.png>)
